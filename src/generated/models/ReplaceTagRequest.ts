...
export function ReplaceTagRequestFromJSON(json: any): ReplaceTagRequest {
    return ReplaceTagRequestFromJSONTyped(json, false);
}

export function ReplaceTagRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReplaceTagRequest {
...
export function ReplaceTagRequestToJSON(value?: ReplaceTagRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
