...
export function OrganizationInfoCarrierSettingsFromJSON(json: any): OrganizationInfoCarrierSettings {
    return OrganizationInfoCarrierSettingsFromJSONTyped(json, false);
}

export function OrganizationInfoCarrierSettingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrganizationInfoCarrierSettings {
...
export function OrganizationInfoCarrierSettingsToJSON(value?: OrganizationInfoCarrierSettings | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
