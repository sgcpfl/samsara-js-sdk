...
import {
    ...
    AttributeToJSON,
    AttributeEntity,
    AttributeEntityFromJSON,
    AttributeEntityFromJSONTyped,
    AttributeEntityToJSON,
    AttributeExpandedAllOf,
    AttributeExpandedAllOfFromJSON,
    AttributeExpandedAllOfFromJSONTyped,
    AttributeExpandedAllOfToJSON,
} from './';
...
export function AttributeExpandedFromJSON(json: any): AttributeExpanded {
    return AttributeExpandedFromJSONTyped(json, false);
}

export function AttributeExpandedFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttributeExpanded {
    ...
    return {
        ...
        'attributeValueQuantity': !exists(json, 'attributeValueQuantity') ? undefined : json['attributeValueQuantity'],
        ...
        'entities': ((json['entities'] as Array<any>).map(AttributeEntityFromJSON)),
    };
}

export function AttributeExpandedToJSON(value?: AttributeExpanded | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'entities': ((value.entities as Array<any>).map(AttributeEntityToJSON)),
    };
}
