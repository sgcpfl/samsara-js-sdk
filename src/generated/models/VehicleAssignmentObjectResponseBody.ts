...
export function VehicleAssignmentObjectResponseBodyFromJSON(json: any): VehicleAssignmentObjectResponseBody {
    return VehicleAssignmentObjectResponseBodyFromJSONTyped(json, false);
}

export function VehicleAssignmentObjectResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): VehicleAssignmentObjectResponseBody {
...
export function VehicleAssignmentObjectResponseBodyToJSON(value?: VehicleAssignmentObjectResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
