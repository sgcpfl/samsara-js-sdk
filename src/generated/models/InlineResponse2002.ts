...
import {
    ...
    V1AssetCurrentLocationsResponseFromJSON,
    V1AssetCurrentLocationsResponseFromJSONTyped,
    V1AssetCurrentLocationsResponseToJSON,
    V1Pagination,
...
export function InlineResponse2002FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2002 {
    ...
    return {
        ...
        'assets': !exists(json, 'assets') ? undefined : ((json['assets'] as Array<any>).map(V1AssetCurrentLocationsResponseFromJSON)),
...
export function InlineResponse2002ToJSON(value?: InlineResponse2002 | null): any {
    ...
    return {
        ...
        'assets': value.assets === undefined ? undefined : ((value.assets as Array<any>).map(V1AssetCurrentLocationsResponseToJSON)),
