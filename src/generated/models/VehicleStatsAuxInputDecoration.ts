...
export function VehicleStatsAuxInputDecorationFromJSON(json: any): VehicleStatsAuxInputDecoration {
    return VehicleStatsAuxInputDecorationFromJSONTyped(json, false);
}

export function VehicleStatsAuxInputDecorationFromJSONTyped(json: any, ignoreDiscriminator: boolean): VehicleStatsAuxInputDecoration {
...
export function VehicleStatsAuxInputDecorationToJSON(value?: VehicleStatsAuxInputDecoration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
