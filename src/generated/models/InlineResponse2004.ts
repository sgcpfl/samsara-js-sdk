...
import {
    ...
    V1VehicleMaintenanceFromJSON,
    V1VehicleMaintenanceFromJSONTyped,
    V1VehicleMaintenanceToJSON,
} from './';
...
export function InlineResponse2004FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2004 {
    ...
    return {
        ...
        'vehicles': !exists(json, 'vehicles') ? undefined : ((json['vehicles'] as Array<any>).map(V1VehicleMaintenanceFromJSON)),
    };
}
...
export function InlineResponse2004ToJSON(value?: InlineResponse2004 | null): any {
    ...
    return {
        ...
        'vehicles': value.vehicles === undefined ? undefined : ((value.vehicles as Array<any>).map(V1VehicleMaintenanceToJSON)),
    };
}
