...
export function CreateDriverRequestCarrierSettingsFromJSON(json: any): CreateDriverRequestCarrierSettings {
    return CreateDriverRequestCarrierSettingsFromJSONTyped(json, false);
}

export function CreateDriverRequestCarrierSettingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateDriverRequestCarrierSettings {
...
export function CreateDriverRequestCarrierSettingsToJSON(value?: CreateDriverRequestCarrierSettings | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
