...
export function InlineResponse2008FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2008 {
    ...
    return {
        ...
        'machines': !exists(json, 'machines') ? undefined : ((json['machines'] as Array<any>).map(V1MachineFromJSON)),
    };
}
...
export function InlineResponse2008ToJSON(value?: InlineResponse2008 | null): any {
    ...
    return {
        ...
        'machines': value.machines === undefined ? undefined : ((value.machines as Array<any>).map(V1MachineToJSON)),
    };
}
