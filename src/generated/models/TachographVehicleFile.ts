...
export function TachographVehicleFileFromJSON(json: any): TachographVehicleFile {
    return TachographVehicleFileFromJSONTyped(json, false);
}

export function TachographVehicleFileFromJSONTyped(json: any, ignoreDiscriminator: boolean): TachographVehicleFile {
...
export function TachographVehicleFileToJSON(value?: TachographVehicleFile | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
