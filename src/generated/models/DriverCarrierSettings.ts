...
export function DriverCarrierSettingsFromJSON(json: any): DriverCarrierSettings {
    return DriverCarrierSettingsFromJSONTyped(json, false);
}

export function DriverCarrierSettingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DriverCarrierSettings {
...
export function DriverCarrierSettingsToJSON(value?: DriverCarrierSettings | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
