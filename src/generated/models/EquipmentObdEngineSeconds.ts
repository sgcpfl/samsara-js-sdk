...
export function EquipmentObdEngineSecondsFromJSON(json: any): EquipmentObdEngineSeconds {
    return EquipmentObdEngineSecondsFromJSONTyped(json, false);
}

export function EquipmentObdEngineSecondsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentObdEngineSeconds {
...
export function EquipmentObdEngineSecondsToJSON(value?: EquipmentObdEngineSeconds | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
