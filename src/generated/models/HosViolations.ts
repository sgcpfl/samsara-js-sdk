...
export function HosViolationsFromJSON(json: any): HosViolations {
    return HosViolationsFromJSONTyped(json, false);
}

export function HosViolationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): HosViolations {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'cycleViolationDurationMs': !exists(json, 'cycleViolationDurationMs') ? undefined : json['cycleViolationDurationMs'],
        'shiftDrivingViolationDurationMs': !exists(json, 'shiftDrivingViolationDurationMs') ? undefined : json['shiftDrivingViolationDurationMs'],
    };
}

export function HosViolationsToJSON(value?: HosViolations | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'cycleViolationDurationMs': value.cycleViolationDurationMs,
        'shiftDrivingViolationDurationMs': value.shiftDrivingViolationDurationMs,
    };
}
