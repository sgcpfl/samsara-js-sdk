...
export function VehicleStatsListSyntheticEngineSecondsFromJSON(json: any): VehicleStatsListSyntheticEngineSeconds {
    return VehicleStatsListSyntheticEngineSecondsFromJSONTyped(json, false);
}

export function VehicleStatsListSyntheticEngineSecondsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VehicleStatsListSyntheticEngineSeconds {
...
export function VehicleStatsListSyntheticEngineSecondsToJSON(value?: VehicleStatsListSyntheticEngineSeconds | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
