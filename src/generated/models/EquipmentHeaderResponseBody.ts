 ...
 * @export
 * @interface EquipmentHeaderResponseBody
 */
export interface EquipmentHeaderResponseBody {
    /**
     ...
     * @type {string}
     * @memberof EquipmentHeaderResponseBody
     */
    equipmentID?: string;
    /**
...
export function EquipmentHeaderResponseBodyFromJSON(json: any): EquipmentHeaderResponseBody {
    return EquipmentHeaderResponseBodyFromJSONTyped(json, false);
}

export function EquipmentHeaderResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentHeaderResponseBody {
...
export function EquipmentHeaderResponseBodyToJSON(value?: EquipmentHeaderResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
