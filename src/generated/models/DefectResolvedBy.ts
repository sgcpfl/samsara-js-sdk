...
export function DefectResolvedByFromJSON(json: any): DefectResolvedBy {
    return DefectResolvedByFromJSONTyped(json, false);
}

export function DefectResolvedByFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefectResolvedBy {
...
export function DefectResolvedByToJSON(value?: DefectResolvedBy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
