...
export function EquipmentObdEngineStateFromJSON(json: any): EquipmentObdEngineState {
    return EquipmentObdEngineStateFromJSONTyped(json, false);
}

export function EquipmentObdEngineStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentObdEngineState {
...
export function EquipmentObdEngineStateToJSON(value?: EquipmentObdEngineState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
