...
export function VehicleStatsAuxInputFromJSON(json: any): VehicleStatsAuxInput {
    return VehicleStatsAuxInputFromJSONTyped(json, false);
}

export function VehicleStatsAuxInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): VehicleStatsAuxInput {
...
export function VehicleStatsAuxInputToJSON(value?: VehicleStatsAuxInput | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
