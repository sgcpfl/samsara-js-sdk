...
import {
    ...
    EquipmentStatsResponseDataFromJSON,
    EquipmentStatsResponseDataFromJSONTyped,
    EquipmentStatsResponseDataToJSON,
    PaginationResponse,
...
export function EquipmentStatsResponseFromJSON(json: any): EquipmentStatsResponse {
    return EquipmentStatsResponseFromJSONTyped(json, false);
}

export function EquipmentStatsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentStatsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(EquipmentStatsResponseDataFromJSON)),
        'pagination': PaginationResponseFromJSON(json['pagination']),
    };
}

export function EquipmentStatsResponseToJSON(value?: EquipmentStatsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': ((value.data as Array<any>).map(EquipmentStatsResponseDataToJSON)),
