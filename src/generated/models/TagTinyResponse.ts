...
export function TagTinyResponseFromJSON(json: any): TagTinyResponse {
    return TagTinyResponseFromJSONTyped(json, false);
}

export function TagTinyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TagTinyResponse {
...
export function TagTinyResponseToJSON(value?: TagTinyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
