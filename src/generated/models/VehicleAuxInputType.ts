...
export function VehicleAuxInputTypeFromJSON(json: any): VehicleAuxInputType {
    return VehicleAuxInputTypeFromJSONTyped(json, false);
}

export function VehicleAuxInputTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): VehicleAuxInputType {
    return json as VehicleAuxInputType;
}

export function VehicleAuxInputTypeToJSON(value?: VehicleAuxInputType | null): any {
    return value as any;
}
