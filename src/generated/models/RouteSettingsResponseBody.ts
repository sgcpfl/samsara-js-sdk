...
export function RouteSettingsResponseBodyFromJSON(json: any): RouteSettingsResponseBody {
    return RouteSettingsResponseBodyFromJSONTyped(json, false);
}

export function RouteSettingsResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteSettingsResponseBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'routeCompletionCondition': !exists(json, 'routeCompletionCondition') ? undefined : json['routeCompletionCondition'],
        'routeStartingCondition': !exists(json, 'routeStartingCondition') ? undefined : json['routeStartingCondition'],
    };
}

export function RouteSettingsResponseBodyToJSON(value?: RouteSettingsResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'routeCompletionCondition': value.routeCompletionCondition,
        'routeStartingCondition': value.routeStartingCondition,
    };
}
