...
import {
    ...
    CreateAddressRequestGeofenceFromJSON,
    CreateAddressRequestGeofenceFromJSONTyped,
    CreateAddressRequestGeofenceToJSON,
} from './';
...
export function UpdateAddressRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateAddressRequest {
    ...
    return {
        ...
        'geofence': !exists(json, 'geofence') ? undefined : CreateAddressRequestGeofenceFromJSON(json['geofence']),
...
export function UpdateAddressRequestToJSON(value?: UpdateAddressRequest | null): any {
    ...
    return {
        ...
        'geofence': CreateAddressRequestGeofenceToJSON(value.geofence),
