...
import {
    ...
    V1DispatchJobWithoutETAFromJSON,
    V1DispatchJobWithoutETAFromJSONTyped,
    V1DispatchJobWithoutETAToJSON,
    V1DispatchRouteBase,
    V1DispatchRouteBaseFromJSON,
    V1DispatchRouteBaseFromJSONTyped,
    V1DispatchRouteBaseToJSON,
    V1DispatchRouteWithoutETAAllOf,
    V1DispatchRouteWithoutETAAllOfFromJSON,
    V1DispatchRouteWithoutETAAllOfFromJSONTyped,
    V1DispatchRouteWithoutETAAllOfToJSON,
} from './';
...
export interface V1DispatchRouteWithoutETA {
     ...
     */
    dispatchJobs?: Array<V1DispatchJobWithoutETA>;
    /**
...
export function V1DispatchRouteWithoutETAFromJSON(json: any): V1DispatchRouteWithoutETA {
    return V1DispatchRouteWithoutETAFromJSONTyped(json, false);
}

export function V1DispatchRouteWithoutETAFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DispatchRouteWithoutETA {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'dispatchJobs': !exists(json, 'dispatch_jobs') ? undefined : ((json['dispatch_jobs'] as Array<any>).map(V1DispatchJobWithoutETAFromJSON)),
...
export function V1DispatchRouteWithoutETAToJSON(value?: V1DispatchRouteWithoutETA | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'dispatch_jobs': value.dispatchJobs === undefined ? undefined : ((value.dispatchJobs as Array<any>).map(V1DispatchJobWithoutETAToJSON)),
        'id': value.id,
