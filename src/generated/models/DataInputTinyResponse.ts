...
export function DataInputTinyResponseFromJSON(json: any): DataInputTinyResponse {
    return DataInputTinyResponseFromJSONTyped(json, false);
}

export function DataInputTinyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DataInputTinyResponse {
...
export function DataInputTinyResponseToJSON(value?: DataInputTinyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
