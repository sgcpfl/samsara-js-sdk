...
import {
    ...
    OrganizationInfoCarrierSettingsFromJSON,
    OrganizationInfoCarrierSettingsFromJSONTyped,
    OrganizationInfoCarrierSettingsToJSON,
} from './';
...
export function OrganizationInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrganizationInfo {
    ...
    return {
        ...
        'carrierSettings': !exists(json, 'carrierSettings') ? undefined : OrganizationInfoCarrierSettingsFromJSON(json['carrierSettings']),
...
export function OrganizationInfoToJSON(value?: OrganizationInfo | null): any {
    ...
    return {
        ...
        'carrierSettings': OrganizationInfoCarrierSettingsToJSON(value.carrierSettings),
        'id': value.id,
        'name': value.name,
    };
}
