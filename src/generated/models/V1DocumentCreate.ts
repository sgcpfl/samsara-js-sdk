...
import {
    ...
    V1DocumentCreateAllOfFromJSON,
    V1DocumentCreateAllOfFromJSONTyped,
    V1DocumentCreateAllOfToJSON,
    V1DocumentCreateBase,
    V1DocumentCreateBaseFromJSON,
    V1DocumentCreateBaseFromJSONTyped,
    V1DocumentCreateBaseToJSON,
} from './';
...
export function V1DocumentCreateFromJSON(json: any): V1DocumentCreate {
    return V1DocumentCreateFromJSONTyped(json, false);
}

export function V1DocumentCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DocumentCreate {
...
export function V1DocumentCreateToJSON(value?: V1DocumentCreate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
