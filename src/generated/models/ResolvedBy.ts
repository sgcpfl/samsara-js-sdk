...
export function ResolvedByFromJSON(json: any): ResolvedBy {
    return ResolvedByFromJSONTyped(json, false);
}

export function ResolvedByFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResolvedBy {
...
export function ResolvedByToJSON(value?: ResolvedBy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
