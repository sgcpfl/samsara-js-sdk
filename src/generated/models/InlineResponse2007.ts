...
import {
    ...
    V1TrailerAssignmentsResponseFromJSONTyped,
...
export function InlineResponse2007FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2007 {
    ...
    return {
        ...
        'trailers': !exists(json, 'trailers') ? undefined : ((json['trailers'] as Array<any>).map(V1TrailerAssignmentsResponseFromJSON)),
    };
}
...
export function InlineResponse2007ToJSON(value?: InlineResponse2007 | null): any {
    ...
    return {
        ...
        'trailers': value.trailers === undefined ? undefined : ((value.trailers as Array<any>).map(V1TrailerAssignmentsResponseToJSON)),
    };
}
