...
export function V1DocumentCreateBaseFromJSON(json: any): V1DocumentCreateBase {
    return V1DocumentCreateBaseFromJSONTyped(json, false);
}

export function V1DocumentCreateBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DocumentCreateBase {
...
export function V1DocumentCreateBaseToJSON(value?: V1DocumentCreateBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
