...
export function V1DocumentCreateAllOfFromJSON(json: any): V1DocumentCreateAllOf {
    return V1DocumentCreateAllOfFromJSONTyped(json, false);
}

export function V1DocumentCreateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DocumentCreateAllOf {
...
export function V1DocumentCreateAllOfToJSON(value?: V1DocumentCreateAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
