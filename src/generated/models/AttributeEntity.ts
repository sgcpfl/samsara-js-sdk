...
export function AttributeEntityFromJSON(json: any): AttributeEntity {
    return AttributeEntityFromJSONTyped(json, false);
}

export function AttributeEntityFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttributeEntity {
...
export function AttributeEntityToJSON(value?: AttributeEntity | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
