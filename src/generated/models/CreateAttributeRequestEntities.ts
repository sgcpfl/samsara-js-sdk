...
export function CreateAttributeRequestEntitiesFromJSON(json: any): CreateAttributeRequestEntities {
    return CreateAttributeRequestEntitiesFromJSONTyped(json, false);
}

export function CreateAttributeRequestEntitiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateAttributeRequestEntities {
...
export function CreateAttributeRequestEntitiesToJSON(value?: CreateAttributeRequestEntities | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
