...
export function UserRoleAssignmentRequestFromJSON(json: any): UserRoleAssignmentRequest {
    return UserRoleAssignmentRequestFromJSONTyped(json, false);
}

export function UserRoleAssignmentRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserRoleAssignmentRequest {
...
export function UserRoleAssignmentRequestToJSON(value?: UserRoleAssignmentRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
