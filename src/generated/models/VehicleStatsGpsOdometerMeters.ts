...
export function VehicleStatsGpsOdometerMetersFromJSON(json: any): VehicleStatsGpsOdometerMeters {
    return VehicleStatsGpsOdometerMetersFromJSONTyped(json, false);
}

export function VehicleStatsGpsOdometerMetersFromJSONTyped(json: any, ignoreDiscriminator: boolean): VehicleStatsGpsOdometerMeters {
...
export function VehicleStatsGpsOdometerMetersToJSON(value?: VehicleStatsGpsOdometerMeters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
