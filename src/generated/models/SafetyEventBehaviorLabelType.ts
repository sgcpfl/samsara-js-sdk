...
export function SafetyEventBehaviorLabelTypeFromJSON(json: any): SafetyEventBehaviorLabelType {
    return SafetyEventBehaviorLabelTypeFromJSONTyped(json, false);
}

export function SafetyEventBehaviorLabelTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SafetyEventBehaviorLabelType {
    return json as SafetyEventBehaviorLabelType;
}

export function SafetyEventBehaviorLabelTypeToJSON(value?: SafetyEventBehaviorLabelType | null): any {
    return value as any;
}
