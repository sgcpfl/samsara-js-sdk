...
import {
    DefectResolvedBy,
    DefectResolvedByFromJSON,
    DefectResolvedByFromJSONTyped,
    DefectResolvedByToJSON,
    TrailerTinyResponse,
    TrailerTinyResponseFromJSON,
    TrailerTinyResponseFromJSONTyped,
    TrailerTinyResponseToJSON,
    VehicleTinyResponse,
...
export function DefectFromJSONTyped(json: any, ignoreDiscriminator: boolean): Defect {
    ...
    return {
        ...
        'mechanicNotesUpdatedAtTime': !exists(json, 'mechanicNotesUpdatedAtTime') ? undefined : json['mechanicNotesUpdatedAtTime'],
        'resolvedAtTime': !exists(json, 'resolvedAtTime') ? undefined : json['resolvedAtTime'],
        'resolvedBy': !exists(json, 'resolvedBy') ? undefined : DefectResolvedByFromJSON(json['resolvedBy']),
        'trailer': !exists(json, 'trailer') ? undefined :  TrailerTinyResponseFromJSON(json['trailer']),
...
export function DefectToJSON(value?: Defect | null): any {
    ...
    return {
        ...
        'mechanicNotesUpdatedAtTime': value.mechanicNotesUpdatedAtTime,
        'resolvedAtTime': value.resolvedAtTime,
        'resolvedBy': DefectResolvedByToJSON(value.resolvedBy),
        'trailer':  TrailerTinyResponseToJSON(value.trailer),
