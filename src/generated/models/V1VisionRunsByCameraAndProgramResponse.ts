...
export function V1VisionRunsByCameraAndProgramResponseFromJSON(json: any): V1VisionRunsByCameraAndProgramResponse {
    return V1VisionRunsByCameraAndProgramResponseFromJSONTyped(json, false);
}

export function V1VisionRunsByCameraAndProgramResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1VisionRunsByCameraAndProgramResponse {
    ...
    return {
        ...
        'reportMetadata': !exists(json, 'reportMetadata') ? undefined : V1VisionRunByCameraResponseRunSummaryFromJSON(json['reportMetadata']),
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(V1VisionRunByCameraResponseInspectionResultsFromJSON)),
        'startedAtMs': !exists(json, 'startedAtMs') ? undefined : json['startedAtMs'],
    };
}

export function V1VisionRunsByCameraAndProgramResponseToJSON(value?: V1VisionRunsByCameraAndProgramResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'reportMetadata': V1VisionRunByCameraResponseRunSummaryToJSON(value.reportMetadata),
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(V1VisionRunByCameraResponseInspectionResultsToJSON)),
