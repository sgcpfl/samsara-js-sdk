...
export function V1DocumentBaseFromJSON(json: any): V1DocumentBase {
    return V1DocumentBaseFromJSONTyped(json, false);
}

export function V1DocumentBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DocumentBase {
...
export function V1DocumentBaseToJSON(value?: V1DocumentBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
