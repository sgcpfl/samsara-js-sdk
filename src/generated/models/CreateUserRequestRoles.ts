...
export function CreateUserRequestRolesFromJSON(json: any): CreateUserRequestRoles {
    return CreateUserRequestRolesFromJSONTyped(json, false);
}

export function CreateUserRequestRolesFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateUserRequestRoles {
...
export function CreateUserRequestRolesToJSON(value?: CreateUserRequestRoles | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
