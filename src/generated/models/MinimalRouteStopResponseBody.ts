...
export function MinimalRouteStopResponseBodyFromJSON(json: any): MinimalRouteStopResponseBody {
    return MinimalRouteStopResponseBodyFromJSONTyped(json, false);
}

export function MinimalRouteStopResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): MinimalRouteStopResponseBody {
...
export function MinimalRouteStopResponseBodyToJSON(value?: MinimalRouteStopResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
