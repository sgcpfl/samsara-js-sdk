...
export function EquipmentGatewayEngineStateFromJSON(json: any): EquipmentGatewayEngineState {
    return EquipmentGatewayEngineStateFromJSONTyped(json, false);
}

export function EquipmentGatewayEngineStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentGatewayEngineState {
...
export function EquipmentGatewayEngineStateToJSON(value?: EquipmentGatewayEngineState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
