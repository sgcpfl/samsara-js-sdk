...
export function V1TrailerAssignmentResponseFromJSON(json: any): V1TrailerAssignmentResponse {
    return V1TrailerAssignmentResponseFromJSONTyped(json, false);
}

export function V1TrailerAssignmentResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1TrailerAssignmentResponse {
...
export function V1TrailerAssignmentResponseToJSON(value?: V1TrailerAssignmentResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
