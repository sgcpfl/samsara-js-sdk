...
export function TachographDriverFileFromJSON(json: any): TachographDriverFile {
    return TachographDriverFileFromJSONTyped(json, false);
}

export function TachographDriverFileFromJSONTyped(json: any, ignoreDiscriminator: boolean): TachographDriverFile {
...
export function TachographDriverFileToJSON(value?: TachographDriverFile | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
