...
export function EngineStatusResponseBodyFromJSON(json: any): EngineStatusResponseBody {
    return EngineStatusResponseBodyFromJSONTyped(json, false);
}

export function EngineStatusResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): EngineStatusResponseBody {
...
export function EngineStatusResponseBodyToJSON(value?: EngineStatusResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
