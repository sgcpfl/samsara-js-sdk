...
export function V1TemperatureResponseSensorsFromJSON(json: any): V1TemperatureResponseSensors {
    return V1TemperatureResponseSensorsFromJSONTyped(json, false);
}

export function V1TemperatureResponseSensorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1TemperatureResponseSensors {
    ...
    return {
        ...
        'ambientTemperatureTime': !exists(json, 'ambientTemperatureTime') ? undefined : json['ambientTemperatureTime'],
        'id': !exists(json, 'id') ? undefined : json['id'],
        'name': !exists(json, 'name') ? undefined : json['name'],
        'probeTemperature': !exists(json, 'probeTemperature') ? undefined : json['probeTemperature'],
        'probeTemperatureTime': !exists(json, 'probeTemperatureTime') ? undefined : json['probeTemperatureTime'],
        'trailerId': !exists(json, 'trailerId') ? undefined : json['trailerId'],
        'vehicleId': !exists(json, 'vehicleId') ? undefined : json['vehicleId'],
    };
}

export function V1TemperatureResponseSensorsToJSON(value?: V1TemperatureResponseSensors | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'ambientTemperatureTime': value.ambientTemperatureTime,
        'id': value.id,
        'name': value.name,
        'probeTemperature': value.probeTemperature,
        'probeTemperatureTime': value.probeTemperatureTime,
