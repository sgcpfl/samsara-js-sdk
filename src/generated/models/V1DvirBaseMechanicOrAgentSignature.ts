...
export function V1DvirBaseMechanicOrAgentSignatureFromJSON(json: any): V1DvirBaseMechanicOrAgentSignature {
    return V1DvirBaseMechanicOrAgentSignatureFromJSONTyped(json, false);
}

export function V1DvirBaseMechanicOrAgentSignatureFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DvirBaseMechanicOrAgentSignature {
...
export function V1DvirBaseMechanicOrAgentSignatureToJSON(value?: V1DvirBaseMechanicOrAgentSignature | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
