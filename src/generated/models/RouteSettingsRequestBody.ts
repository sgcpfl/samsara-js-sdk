...
export function RouteSettingsRequestBodyFromJSON(json: any): RouteSettingsRequestBody {
    return RouteSettingsRequestBodyFromJSONTyped(json, false);
}

export function RouteSettingsRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteSettingsRequestBody {
...
export function RouteSettingsRequestBodyToJSON(value?: RouteSettingsRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
