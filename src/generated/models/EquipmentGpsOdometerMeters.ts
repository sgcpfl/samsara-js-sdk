...
export function EquipmentGpsOdometerMetersFromJSON(json: any): EquipmentGpsOdometerMeters {
    return EquipmentGpsOdometerMetersFromJSONTyped(json, false);
}

export function EquipmentGpsOdometerMetersFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentGpsOdometerMeters {
...
export function EquipmentGpsOdometerMetersToJSON(value?: EquipmentGpsOdometerMeters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
