...
export function V1DvirBaseNextDriverSignatureFromJSON(json: any): V1DvirBaseNextDriverSignature {
    return V1DvirBaseNextDriverSignatureFromJSONTyped(json, false);
}

export function V1DvirBaseNextDriverSignatureFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DvirBaseNextDriverSignature {
...
export function V1DvirBaseNextDriverSignatureToJSON(value?: V1DvirBaseNextDriverSignature | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
