...
export function EquipmentGatewayJ1939EngineSecondsFromJSON(json: any): EquipmentGatewayJ1939EngineSeconds {
    return EquipmentGatewayJ1939EngineSecondsFromJSONTyped(json, false);
}

export function EquipmentGatewayJ1939EngineSecondsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentGatewayJ1939EngineSeconds {
...
export function EquipmentGatewayJ1939EngineSecondsToJSON(value?: EquipmentGatewayJ1939EngineSeconds | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
