...
export function EquipmentGatewayEngineSecondsFromJSON(json: any): EquipmentGatewayEngineSeconds {
    return EquipmentGatewayEngineSecondsFromJSONTyped(json, false);
}

export function EquipmentGatewayEngineSecondsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentGatewayEngineSeconds {
...
export function EquipmentGatewayEngineSecondsToJSON(value?: EquipmentGatewayEngineSeconds | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
