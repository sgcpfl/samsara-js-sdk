...
import {
    ...
    V1SensorsHistorySeriesFromJSON,
    V1SensorsHistorySeriesFromJSONTyped,
    V1SensorsHistorySeriesToJSON,
} from './';
...
export function InlineObject6FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineObject6 {
    ...
    return {
        ...
        'series': ((json['series'] as Array<any>).map(V1SensorsHistorySeriesFromJSON)),
...
export function InlineObject6ToJSON(value?: InlineObject6 | null): any {
    ...
    return {
        ...
        'series': ((value.series as Array<any>).map(V1SensorsHistorySeriesToJSON)),
