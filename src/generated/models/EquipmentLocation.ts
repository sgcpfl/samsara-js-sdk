...
export function EquipmentLocationFromJSON(json: any): EquipmentLocation {
    return EquipmentLocationFromJSONTyped(json, false);
}

export function EquipmentLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentLocation {
...
export function EquipmentLocationToJSON(value?: EquipmentLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
