...
import {
    ...
    GatewayAssetResponseObjectResponseBodyToJSON,
} from './';
...
export function GatewayResponseObjectResponseBodyFromJSON(json: any): GatewayResponseObjectResponseBody {
    return GatewayResponseObjectResponseBodyFromJSONTyped(json, false);
}

export function GatewayResponseObjectResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): GatewayResponseObjectResponseBody {
...
export function GatewayResponseObjectResponseBodyToJSON(value?: GatewayResponseObjectResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
