...
export function AddressGeofenceCircleFromJSON(json: any): AddressGeofenceCircle {
    return AddressGeofenceCircleFromJSONTyped(json, false);
}

export function AddressGeofenceCircleFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddressGeofenceCircle {
...
export function AddressGeofenceCircleToJSON(value?: AddressGeofenceCircle | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
