...
import {
    ...
    FieldObjectPostRequestBodyFromJSON,
    FieldObjectPostRequestBodyFromJSONTyped,
    FieldObjectPostRequestBodyToJSON,
} from './';
...
export function DocumentsPostDocumentRequestBodyFromJSON(json: any): DocumentsPostDocumentRequestBody {
    return DocumentsPostDocumentRequestBodyFromJSONTyped(json, false);
}

export function DocumentsPostDocumentRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentsPostDocumentRequestBody {
    ...
    return {
        ...
        'fields': !exists(json, 'fields') ? undefined : ((json['fields'] as Array<any>).map(FieldObjectPostRequestBodyFromJSON)),
        'name': !exists(json, 'name') ? undefined : json['name'],
        'notes': !exists(json, 'notes') ? undefined : json['notes'],
        'routeStopId': !exists(json, 'routeStopId') ? undefined : json['routeStopId'],
        'state': !exists(json, 'state') ? undefined : json['state'],
        'vehicleId': !exists(json, 'vehicleId') ? undefined : json['vehicleId'],
    };
}

export function DocumentsPostDocumentRequestBodyToJSON(value?: DocumentsPostDocumentRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'fields': value.fields === undefined ? undefined : ((value.fields as Array<any>).map(FieldObjectPostRequestBodyToJSON)),
        'name': value.name,
        'notes': value.notes,
