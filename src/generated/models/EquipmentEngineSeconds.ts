...
export function EquipmentEngineSecondsFromJSON(json: any): EquipmentEngineSeconds {
    return EquipmentEngineSecondsFromJSONTyped(json, false);
}

export function EquipmentEngineSecondsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentEngineSeconds {
...
export function EquipmentEngineSecondsToJSON(value?: EquipmentEngineSeconds | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
