...
import {
    V1MessageResponse,
    V1MessageResponseFromJSON,
    V1MessageResponseFromJSONTyped,
    V1MessageResponseToJSON,
} from './';
...
export function InlineResponse2005FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2005 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(V1MessageResponseFromJSON)),
    };
}
...
export function InlineResponse2005ToJSON(value?: InlineResponse2005 | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(V1MessageResponseToJSON)),
    };
}
