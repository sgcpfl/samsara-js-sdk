...
export function DriverVehicleGroupTagFromJSON(json: any): DriverVehicleGroupTag {
    return DriverVehicleGroupTagFromJSONTyped(json, false);
}

export function DriverVehicleGroupTagFromJSONTyped(json: any, ignoreDiscriminator: boolean): DriverVehicleGroupTag {
...
export function DriverVehicleGroupTagToJSON(value?: DriverVehicleGroupTag | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
