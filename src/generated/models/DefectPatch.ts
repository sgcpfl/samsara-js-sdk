...
export function DefectPatchFromJSON(json: any): DefectPatch {
    return DefectPatchFromJSONTyped(json, false);
}

export function DefectPatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefectPatch {
    ...
    return {
        ...
        'resolvedBy': !exists(json, 'resolvedBy') ? undefined : ResolvedByFromJSON(json['resolvedBy']),
    };
}

export function DefectPatchToJSON(value?: DefectPatch | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'resolvedBy': ResolvedByToJSON(value.resolvedBy),
    };
}
