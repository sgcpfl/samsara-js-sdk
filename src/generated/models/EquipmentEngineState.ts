...
export function EquipmentEngineStateFromJSON(json: any): EquipmentEngineState {
    return EquipmentEngineStateFromJSONTyped(json, false);
}

export function EquipmentEngineStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EquipmentEngineState {
...
export function EquipmentEngineStateToJSON(value?: EquipmentEngineState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
