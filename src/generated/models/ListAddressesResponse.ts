...
export function ListAddressesResponseFromJSON(json: any): ListAddressesResponse {
    return ListAddressesResponseFromJSONTyped(json, false);
}

export function ListAddressesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAddressesResponse {
...
export function ListAddressesResponseToJSON(value?: ListAddressesResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
