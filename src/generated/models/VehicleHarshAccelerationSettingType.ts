...
export function VehicleHarshAccelerationSettingTypeFromJSON(json: any): VehicleHarshAccelerationSettingType {
    return VehicleHarshAccelerationSettingTypeFromJSONTyped(json, false);
}

export function VehicleHarshAccelerationSettingTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): VehicleHarshAccelerationSettingType {
    return json as VehicleHarshAccelerationSettingType;
}

export function VehicleHarshAccelerationSettingTypeToJSON(value?: VehicleHarshAccelerationSettingType | null): any {
    return value as any;
}
