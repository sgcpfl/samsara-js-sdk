...
export function V1DoorResponseSensorsFromJSON(json: any): V1DoorResponseSensors {
    return V1DoorResponseSensorsFromJSONTyped(json, false);
}

export function V1DoorResponseSensorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DoorResponseSensors {
    ...
    return {
        ...
        'doorStatusTime': !exists(json, 'doorStatusTime') ? undefined : json['doorStatusTime'],
...
export function V1DoorResponseSensorsToJSON(value?: V1DoorResponseSensors | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'doorStatusTime': value.doorStatusTime,
        'id': value.id,
        'name': value.name,
