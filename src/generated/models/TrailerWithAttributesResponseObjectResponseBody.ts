...
export function TrailerWithAttributesResponseObjectResponseBodyFromJSON(json: any): TrailerWithAttributesResponseObjectResponseBody {
    return TrailerWithAttributesResponseObjectResponseBodyFromJSONTyped(json, false);
}

export function TrailerWithAttributesResponseObjectResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): TrailerWithAttributesResponseObjectResponseBody {
...
export function TrailerWithAttributesResponseObjectResponseBodyToJSON(value?: TrailerWithAttributesResponseObjectResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
