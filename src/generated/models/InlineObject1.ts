...
export function InlineObject1FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineObject1 {
    ...
    return {
        ...
        'statusChangeAtMs': !exists(json, 'status_change_at_ms') ? undefined : json['status_change_at_ms'],
...
export function InlineObject1ToJSON(value?: InlineObject1 | null): any {
    ...
    return {
        ...
        'duty_status': value.dutyStatus,
        'location': value.location,
        'remark': value.remark,
        'status_change_at_ms': value.statusChangeAtMs,
