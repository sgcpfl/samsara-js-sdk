...
export function GatewayAssetResponseObjectResponseBodyFromJSON(json: any): GatewayAssetResponseObjectResponseBody {
    return GatewayAssetResponseObjectResponseBodyFromJSONTyped(json, false);
}

export function GatewayAssetResponseObjectResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): GatewayAssetResponseObjectResponseBody {
...
export function GatewayAssetResponseObjectResponseBodyToJSON(value?: GatewayAssetResponseObjectResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
