...
export function DataInputsTinyResponseFromJSON(json: any): DataInputsTinyResponse {
    return DataInputsTinyResponseFromJSONTyped(json, false);
}

export function DataInputsTinyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DataInputsTinyResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(DataInputTinyResponseFromJSON)),
        'pagination': !exists(json, 'pagination') ? undefined : PaginationResponseFromJSON(json['pagination']),
    };
}

export function DataInputsTinyResponseToJSON(value?: DataInputsTinyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(DataInputTinyResponseToJSON)),
