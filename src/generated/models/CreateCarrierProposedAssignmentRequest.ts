...
export function CreateCarrierProposedAssignmentRequestFromJSON(json: any): CreateCarrierProposedAssignmentRequest {
    return CreateCarrierProposedAssignmentRequestFromJSONTyped(json, false);
}

export function CreateCarrierProposedAssignmentRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateCarrierProposedAssignmentRequest {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'activeTime': !exists(json, 'activeTime') ? undefined : json['activeTime'],
...
export function CreateCarrierProposedAssignmentRequestToJSON(value?: CreateCarrierProposedAssignmentRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
