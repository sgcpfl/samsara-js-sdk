...
export function UpdateDvirRequestFromJSON(json: any): UpdateDvirRequest {
    return UpdateDvirRequestFromJSONTyped(json, false);
}

export function UpdateDvirRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateDvirRequest {
...
export function UpdateDvirRequestToJSON(value?: UpdateDvirRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
