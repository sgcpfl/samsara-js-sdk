...
import {
    ...
    RouteSettingsRequestBodyFromJSON,
    RouteSettingsRequestBodyFromJSONTyped,
    RouteSettingsRequestBodyToJSON,
    UpdateRoutesStopRequestObjectRequestBody,
    UpdateRoutesStopRequestObjectRequestBodyFromJSON,
    UpdateRoutesStopRequestObjectRequestBodyFromJSONTyped,
    UpdateRoutesStopRequestObjectRequestBodyToJSON,
} from './';
...
export function RoutesPatchRouteRequestBodyFromJSON(json: any): RoutesPatchRouteRequestBody {
    return RoutesPatchRouteRequestBodyFromJSONTyped(json, false);
}

export function RoutesPatchRouteRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutesPatchRouteRequestBody {
    ...
    return {
        ...
        'settings': !exists(json, 'settings') ? undefined : RouteSettingsRequestBodyFromJSON(json['settings']),
        'stops': !exists(json, 'stops') ? undefined : ((json['stops'] as Array<any>).map(UpdateRoutesStopRequestObjectRequestBodyFromJSON)),
        'vehicleId': !exists(json, 'vehicleId') ? undefined : json['vehicleId'],
    };
}

export function RoutesPatchRouteRequestBodyToJSON(value?: RoutesPatchRouteRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'name': value.name,
        'notes': value.notes,
        'settings': RouteSettingsRequestBodyToJSON(value.settings),
        'stops': value.stops === undefined ? undefined : ((value.stops as Array<any>).map(UpdateRoutesStopRequestObjectRequestBodyToJSON)),
