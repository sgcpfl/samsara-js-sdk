...
export function V1HumidityResponseSensorsFromJSON(json: any): V1HumidityResponseSensors {
    return V1HumidityResponseSensorsFromJSONTyped(json, false);
}

export function V1HumidityResponseSensorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1HumidityResponseSensors {
    ...
    return {
        ...
        'humidityTime': !exists(json, 'humidityTime') ? undefined : json['humidityTime'],
...
export function V1HumidityResponseSensorsToJSON(value?: V1HumidityResponseSensors | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'humidityTime': value.humidityTime,
        'id': value.id,
        'name': value.name,
