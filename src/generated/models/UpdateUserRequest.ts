...
import {
    ...
    CreateUserRequestRolesFromJSON,
    CreateUserRequestRolesFromJSONTyped,
    CreateUserRequestRolesToJSON,
} from './';
...
export function UpdateUserRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateUserRequest {
    ...
    return {
        ...
        'roles': !exists(json, 'roles') ? undefined : ((json['roles'] as Array<any>).map(CreateUserRequestRolesFromJSON)),
    };
}
...
export function UpdateUserRequestToJSON(value?: UpdateUserRequest | null): any {
    ...
    return {
        ...
        'name': value.name,
        'roles': value.roles === undefined ? undefined : ((value.roles as Array<any>).map(CreateUserRequestRolesToJSON)),
    };
}
