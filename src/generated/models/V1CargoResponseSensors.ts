...
export function V1CargoResponseSensorsFromJSON(json: any): V1CargoResponseSensors {
    return V1CargoResponseSensorsFromJSONTyped(json, false);
}

export function V1CargoResponseSensorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1CargoResponseSensors {
    ...
    return {
        ...
        'cargoStatusTime': !exists(json, 'cargoStatusTime') ? undefined : json['cargoStatusTime'],
...
export function V1CargoResponseSensorsToJSON(value?: V1CargoResponseSensors | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'cargoStatusTime': value.cargoStatusTime,
        'id': value.id,
        'name': value.name,
