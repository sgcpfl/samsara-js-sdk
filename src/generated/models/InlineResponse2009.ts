...
export function InlineResponse2009FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2009 {
    ...
    return {
        ...
        'sensors': !exists(json, 'sensors') ? undefined : ((json['sensors'] as Array<any>).map(V1SensorFromJSON)),
    };
}
...
export function InlineResponse2009ToJSON(value?: InlineResponse2009 | null): any {
    ...
    return {
        ...
        'sensors': value.sensors === undefined ? undefined : ((value.sensors as Array<any>).map(V1SensorToJSON)),
    };
}
