...
export function VehicleStatsEngineImmobilizerFromJSON(json: any): VehicleStatsEngineImmobilizer {
    return VehicleStatsEngineImmobilizerFromJSONTyped(json, false);
}

export function VehicleStatsEngineImmobilizerFromJSONTyped(json: any, ignoreDiscriminator: boolean): VehicleStatsEngineImmobilizer {
...
export function VehicleStatsEngineImmobilizerToJSON(value?: VehicleStatsEngineImmobilizer | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
