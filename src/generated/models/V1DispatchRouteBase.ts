...
export function V1DispatchRouteBaseFromJSON(json: any): V1DispatchRouteBase {
    return V1DispatchRouteBaseFromJSONTyped(json, false);
}

export function V1DispatchRouteBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DispatchRouteBase {
...
export function V1DispatchRouteBaseToJSON(value?: V1DispatchRouteBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
