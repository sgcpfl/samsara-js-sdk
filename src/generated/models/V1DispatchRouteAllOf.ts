...
export function V1DispatchRouteAllOfFromJSON(json: any): V1DispatchRouteAllOf {
    return V1DispatchRouteAllOfFromJSONTyped(json, false);
}

export function V1DispatchRouteAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DispatchRouteAllOf {
...
export function V1DispatchRouteAllOfToJSON(value?: V1DispatchRouteAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
