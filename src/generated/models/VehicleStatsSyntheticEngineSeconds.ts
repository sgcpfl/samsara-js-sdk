...
export function VehicleStatsSyntheticEngineSecondsFromJSON(json: any): VehicleStatsSyntheticEngineSeconds {
    return VehicleStatsSyntheticEngineSecondsFromJSONTyped(json, false);
}

export function VehicleStatsSyntheticEngineSecondsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VehicleStatsSyntheticEngineSeconds {
...
export function VehicleStatsSyntheticEngineSecondsToJSON(value?: VehicleStatsSyntheticEngineSeconds | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
