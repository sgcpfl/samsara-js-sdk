...
export function DataInputResponseAllOfFromJSON(json: any): DataInputResponseAllOf {
    return DataInputResponseAllOfFromJSONTyped(json, false);
}

export function DataInputResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): DataInputResponseAllOf {
...
export function DataInputResponseAllOfToJSON(value?: DataInputResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
