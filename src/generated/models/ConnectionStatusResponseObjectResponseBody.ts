...
export function ConnectionStatusResponseObjectResponseBodyFromJSON(json: any): ConnectionStatusResponseObjectResponseBody {
    return ConnectionStatusResponseObjectResponseBodyFromJSONTyped(json, false);
}

export function ConnectionStatusResponseObjectResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionStatusResponseObjectResponseBody {
    ...
    return {
        ...
        'lastConnected': !exists(json, 'lastConnected') ? undefined : json['lastConnected'],
    };
}

export function ConnectionStatusResponseObjectResponseBodyToJSON(value?: ConnectionStatusResponseObjectResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
