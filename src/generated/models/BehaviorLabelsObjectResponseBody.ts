 ...
 * @export
 * @interface BehaviorLabelsObjectResponseBody
 */
export interface BehaviorLabelsObjectResponseBody {
    /**
     ...
     * @type {string}
     * @memberof BehaviorLabelsObjectResponseBody
     */
    label?: BehaviorLabelsObjectResponseBodyLabelEnum;
    /**
     * The source of the label associated with the safety event.
     * @type {string}
     * @memberof BehaviorLabelsObjectResponseBody
     */
    source?: BehaviorLabelsObjectResponseBodySourceEnum;
}
...
* @enum {string}
*/
export enum BehaviorLabelsObjectResponseBodyLabelEnum {
    Invalid = 'invalid',
...
* @enum {string}
*/
export enum BehaviorLabelsObjectResponseBodySourceEnum {
    Invalid = 'invalid',
    System = 'system',
    SamsaraUser = 'samsaraUser',
...
export function BehaviorLabelsObjectResponseBodyFromJSON(json: any): BehaviorLabelsObjectResponseBody {
    return BehaviorLabelsObjectResponseBodyFromJSONTyped(json, false);
}

export function BehaviorLabelsObjectResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): BehaviorLabelsObjectResponseBody {
...
export function BehaviorLabelsObjectResponseBodyToJSON(value?: BehaviorLabelsObjectResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
