...
export function V1SensorsHistorySeriesFromJSON(json: any): V1SensorsHistorySeries {
    return V1SensorsHistorySeriesFromJSONTyped(json, false);
}

export function V1SensorsHistorySeriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1SensorsHistorySeries {
...
export function V1SensorsHistorySeriesToJSON(value?: V1SensorsHistorySeries | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
