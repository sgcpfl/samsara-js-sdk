...
export function DvirTrailerDefectsItemsFromJSON(json: any): DvirTrailerDefectsItems {
    return DvirTrailerDefectsItemsFromJSONTyped(json, false);
}

export function DvirTrailerDefectsItemsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvirTrailerDefectsItems {
    ...
    return {
        ...
        'trailer': !exists(json, 'trailer') ? undefined : json['trailer'],
        'vehicle': !exists(json, 'vehicle') ? undefined : json['vehicle'],
    };
}

export function DvirTrailerDefectsItemsToJSON(value?: DvirTrailerDefectsItems | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
