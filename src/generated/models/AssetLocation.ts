...
export function AssetLocationFromJSON(json: any): AssetLocation {
    return AssetLocationFromJSONTyped(json, false);
}

export function AssetLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetLocation {
...
export function AssetLocationToJSON(value?: AssetLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
