...
import {
    V1DispatchJobAllOf,
    V1DispatchJobAllOfFromJSON,
    V1DispatchJobAllOfFromJSONTyped,
    V1DispatchJobAllOfToJSON,
    V1DispatchJobCreate,
...
export function V1DispatchJobFromJSON(json: any): V1DispatchJob {
    return V1DispatchJobFromJSONTyped(json, false);
}

export function V1DispatchJobFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DispatchJob {
...
export function V1DispatchJobToJSON(value?: V1DispatchJob | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
