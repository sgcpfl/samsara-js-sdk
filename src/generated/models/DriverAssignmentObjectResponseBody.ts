...
export function DriverAssignmentObjectResponseBodyFromJSON(json: any): DriverAssignmentObjectResponseBody {
    return DriverAssignmentObjectResponseBodyFromJSONTyped(json, false);
}

export function DriverAssignmentObjectResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): DriverAssignmentObjectResponseBody {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'assignmentType': !exists(json, 'assignmentType') ? undefined : json['assignmentType'],
        'driver': !exists(json, 'driver') ? undefined : GoaDriverTinyResponseResponseBodyFromJSON(json['driver']),
        'endTime': !exists(json, 'endTime') ? undefined : json['endTime'],
        'isPassenger': !exists(json, 'isPassenger') ? undefined : json['isPassenger'],
        'startTime': !exists(json, 'startTime') ? undefined : json['startTime'],
    };
}

export function DriverAssignmentObjectResponseBodyToJSON(value?: DriverAssignmentObjectResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
