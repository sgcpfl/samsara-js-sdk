...
export function AttributeTinyFromJSON(json: any): AttributeTiny {
    return AttributeTinyFromJSONTyped(json, false);
}

export function AttributeTinyFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttributeTiny {
...
export function AttributeTinyToJSON(value?: AttributeTiny | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
