...
export function TinyTagFromJSON(json: any): TinyTag {
    return TinyTagFromJSONTyped(json, false);
}

export function TinyTagFromJSONTyped(json: any, ignoreDiscriminator: boolean): TinyTag {
...
export function TinyTagToJSON(value?: TinyTag | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
