...
export function GoaPaginationResponseResponseBodyFromJSON(json: any): GoaPaginationResponseResponseBody {
    return GoaPaginationResponseResponseBodyFromJSONTyped(json, false);
}

export function GoaPaginationResponseResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): GoaPaginationResponseResponseBody {
...
export function GoaPaginationResponseResponseBodyToJSON(value?: GoaPaginationResponseResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
