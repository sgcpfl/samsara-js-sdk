...
export function TrailerStatDecorationResponseBodyFromJSON(json: any): TrailerStatDecorationResponseBody {
    return TrailerStatDecorationResponseBodyFromJSONTyped(json, false);
}

export function TrailerStatDecorationResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): TrailerStatDecorationResponseBody {
...
export function TrailerStatDecorationResponseBodyToJSON(value?: TrailerStatDecorationResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
